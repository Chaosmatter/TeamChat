            ...
            if (p.hasPermission("tc.see")) {
                if (args.length > 0) {
                    if (args[0].equalsIgnoreCase("login")) {
                        ...
                        p.sendMessage(TeamChat.prefix + "§ePlugin edited by Chaosmatter");
                        ...
                        if (args[1].equalsIgnoreCase("list")) {
                            if (TeamChat.login.contains(p)) {
                                if (!TeamChat.listed.contains(p)) {
                                    ...
                                    p.sendMessage(TeamChat.prefix + " §7Dein aktueller Server ist bereits nicht zu sehen!");
                                }
                            } else {
                                p.sendMessage(TeamChat.prefix + "§7Für diese Aktion musst du §aeingeloggt §7sein.");
                            }
                        ...
                        for (final ProxiedPlayer all : BungeeCord.getInstance().getPlayers()) {
                            if (all.hasPermission("tc.see")) {
                                if (TeamChat.login.contains(all)) {
                                    ...
                                    if (p.hasPermission("rankcolor.4")) {
                                        all.sendMessage(TeamChat.prefix + "§4" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.b")) {
                                        all.sendMessage(TeamChat.prefix + "§b" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.c")) {
                                        all.sendMessage(TeamChat.prefix + "§c" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.9")) {
                                        all.sendMessage(TeamChat.prefix + "§9" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.1")) {
                                        all.sendMessage(TeamChat.prefix + "§1" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.2")) {
                                        all.sendMessage(TeamChat.prefix + "§2" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.3")) {
                                        all.sendMessage(TeamChat.prefix + "§3" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.5")) {
                                        all.sendMessage(TeamChat.prefix + "§5" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.6")) {
                                        all.sendMessage(TeamChat.prefix + "§6" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.7")) {
                                        all.sendMessage(TeamChat.prefix + "§7" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.8")) {
                                        all.sendMessage(TeamChat.prefix + "§8" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.0")) {
                                        all.sendMessage(TeamChat.prefix + "§0" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.a")) {
                                        all.sendMessage(TeamChat.prefix + "§a" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.e")) {
                                        all.sendMessage(TeamChat.prefix + "§e" + p.getName() + " §8» §7" + nachricht);
                                    } else if (p.hasPermission("rankcolor.d")) {
                                        all.sendMessage(TeamChat.prefix + "§d" + p.getName() + " §8» §7" + nachricht);
                                    } else {
                                        all.sendMessage(TeamChat.prefix + "§d" + p.getName() + " §8» §7" + nachricht);
                                    }
                                } else {
                    ...
                    p.sendMessage(TeamChat.prefix + " §7Nutze: <§alogin §7| §clogout §7| §elist§7 | §bNachricht §7| §3add§7/§3remove list§7>");
                }
            } else {
